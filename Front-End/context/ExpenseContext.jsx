...
const handleSubmit = (e) => {
        ...
        if (
          (formData.type === "percentage" || formData.type === "unequally") && !formData.value) 
          {
    ...
    return (
        <ExpenseContext.Provider value={{ formData, handleChange, handleSubmit, allExpenses, addUser, inputUsers }}>
            {children}
